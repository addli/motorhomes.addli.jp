...
riot$1.tag2('tabbarcontroller', '<div id="{uniqueID()}" class="riot-tag-views"> </div>', 'tabbarcontroller .riot-tag-views,[data-is="tabbarcontroller"] .riot-tag-views{ width: 100%; height: 100%; position: relative; overflow: hidden; box-sizing: border-box; } tabbarcontroller .riot-tag-view,[data-is="tabbarcontroller"] .riot-tag-view{ width: 100%; height: 100%; position: absolute; } tabbarcontroller .riot-tag-inactive-view,[data-is="tabbarcontroller"] .riot-tag-inactive-view{ display: none; }', '', function(opts) {
...
self.on("unmount",function(){
    tags.map( function( tag$$1 ){ tag$$1.unmount(); });
});
...
var addTabViewController = function( tagName, tabOptions ){
    ...
    let tag$$1 = riot$1.mount( "div#" + view.id, tagName , options )[0];
    tags.push(tag$$1);
};
...
var MapImplRepository = (function () {
    function MapImplRepository() {
        var _this = this;
        this.setting = Settings.shared().valueForKey("map");
        this.load = function (handler) {
            if (_this.view) {
                handler(_this.view, undefined);
                return;
            }
            jquery.ajax({
                type: 'GET',
                ...
                _this.map = new google.maps.Map(view, {
                    zoom: _this.setting.zoom,
                    mapTypeControl: false,
                    streetViewControl: false,
                    center: new google.maps.LatLng(_this.setting.center.latitude, _this.setting.center.longitude)
                });
                _this.view = view;
    ...
    return MapImplRepository;
}());

var MapService = (function () {
    function MapService() {
        var _this = this;
        this.mapRepo = new MapImplRepository();
        /**
        * 地図の読み込みを指示する
        * @param handler 結果ハンドラ。読み込みが成功した場合地図機能を持つ<div>エレメントが渡される
        */
        this.loadMap = function (handler) {
            _this.mapRepo.load(handler);
        };
    }
    return MapService;
}());

riot$1.tag2('mapviewcontroller', '<div id="motorhome-map"></div>', 'mapviewcontroller #motorhome-map,[data-is="mapviewcontroller"] #motorhome-map{ width: 100%; height: 100%; background-color: #ffdddd; }', '', function(opts) {
var self = this;

self.service = new MapService();
...
riot$1.tag2('aboutviewcontroller', '<div class="aboutview"> <div class="container"> <section class="widget"> <table class="table"> <thead> <tr> <th class="hidden-sm-down">#</th> <th>Picture</th> <th>Description</th> <th class="hidden-sm-down">Info</th> <th class="hidden-sm-down">Date</th> <th class="hidden-sm-down">Size</th> <th></th> </tr> </thead> <tbody> <tr> <td class="hidden-sm-down">1</td> <td> <img class="img-rounded" src="demo/img/pictures/1.jpg" alt="" height="50"> </td> <td> Palo Alto </td> <td class="hidden-sm-down"> <p class="no-margin"> <small> <span class="fw-semi-bold">Type:</span> <span class="text-semi-muted">&nbsp; JPEG</span> </small> </p> <p> <small> <span class="fw-semi-bold">Dimensions:</span> <span class="text-semi-muted">&nbsp; 200x150</span> </small> </p> </td> <td class="hidden-sm-down text-semi-muted"> September 14, 2012 </td> <td class="hidden-sm-down text-semi-muted"> 45.6 KB </td> <td class="width-150"> <div class="bg-gray-lighter progress-bar"> <progress class="progress progress-sm progress-success js-progress-animate" value="100" max="100" style="width: 0%" data-width="29%"></progress> </div> </td> </tr> <tr> <td class="hidden-sm-down">2</td> <td> <img class="img-rounded" src="demo/img/pictures/2.jpg" alt="" height="50"> </td> <td> The Sky </td> <td class="hidden-sm-down"> <p class="no-margin"> <small> <span class="fw-semi-bold">Type:</span> <span class="text-semi-muted">&nbsp; PSD</span> </small> </p> <p> <small> <span class="fw-semi-bold">Dimensions:</span> <span class="text-semi-muted">&nbsp; 2400x1455</span> </small> </p> </td> <td class="hidden-sm-down text-semi-muted"> November 14, 2012 </td> <td class="hidden-sm-down text-semi-muted"> 15.3 MB </td> <td class="width-150"> <div class="bg-gray-lighter progress-bar"> <progress class="progress progress-sm progress-warning js-progress-animate" value="100" max="100" style="width: 0%" data-width="33%"></progress> </div> </td> </tr> <tr> <td class="hidden-sm-down">3</td> <td> <img class="img-rounded" src="demo/img/pictures/3.jpg" alt="" height="50"> </td> <td> Down the road <br> <span class="label label-danger">INFO!</span> </td> <td class="hidden-sm-down"> <p class="no-margin"> <small> <span class="fw-semi-bold">Type:</span> <span class="text-semi-muted">&nbsp; JPEG</span> </small> </p> <p> <small> <span class="fw-semi-bold">Dimensions:</span> <span class="text-semi-muted">&nbsp; 200x150</span> </small> </p> </td> <td class="hidden-sm-down text-semi-muted"> September 14, 2012 </td> <td class="hidden-sm-down text-semi-muted"> 49.0 KB </td> <td class="width-150"> <div class="bg-gray-lighter progress-bar"> <progress class="progress progress-sm progress-bar-gray js-progress-animate" value="100" max="100" style="width: 0%" data-width="38%"></progress> </div> </td> </tr> <tr> <td class="hidden-sm-down">4</td> <td> <img class="img-rounded" src="demo/img/pictures/4.jpg" alt="" height="50"> </td> <td> The Edge </td> <td class="hidden-sm-down"> <p class="no-margin"> <small> <span class="fw-semi-bold">Type:</span> <span class="text-semi-muted">&nbsp; PNG</span> </small> </p> <p> <small> <span class="fw-semi-bold">Dimensions:</span> <span class="text-semi-muted">&nbsp; 210x160</span> </small> </p> </td> <td class="hidden-sm-down text-semi-muted"> September 15, 2012 </td> <td class="hidden-sm-down text-semi-muted"> 69.1 KB </td> <td class="width-150"> <div class="bg-gray-lighter progress-bar"> <progress class="progress progress-sm progress-danger js-progress-animate" value="100" max="100" style="width: 0%" data-width="17%"></progress> </div> </td> </tr> <tr> <td class="hidden-sm-down">5</td> <td> <img class="img-rounded" src="demo/img/pictures/11.jpg" alt="" height="50"> </td> <td> Fortress </td> <td class="hidden-sm-down"> <p class="no-margin"> <small> <span class="fw-semi-bold">Type:</span> <span class="text-semi-muted">&nbsp; JPEG</span> </small> </p> <p> <small> <span class="fw-semi-bold">Dimensions:</span> <span class="text-semi-muted">&nbsp; 1452x1320</span> </small> </p> </td> <td class="hidden-sm-down text-semi-muted"> October 1, 2012 </td> <td class="hidden-sm-down text-semi-muted"> 2.3 MB </td> <td class="width-150"> <div class="bg-gray-lighter progress-bar"> <progress class="progress progress-sm progress-primary js-progress-animate" value="100" max="100" style="width: 0%" data-width="41%"></progress> </div> </td> </tr> </tbody> </table> </section> <div class="row"> <div class="col-12 col-lg-6"> <h1>Hello secondviewcontroller!!</h1> </div> <div class="col-12 col-lg-6"> </div> </div> </div> </div>', 'aboutviewcontroller .aboutview,[data-is="aboutviewcontroller"] .aboutview{ width: 100%; height: 100%; padding-top: 16px; background-color: #eee; }', '', function(opts) {
var self = this;

self.onClickTabButton = function(){
    self.opts.tab.setSelectedIndex(0);
};
});

riot$1.tag2('rootviewcontroller', '<header> <div class="navigation-bar"> <div class="left"> <div class="item"> <span class="glyphicon glyphicon-chevron-left"></span> </div> </div> <div class="title"> moterhomes </div> <div class="right"> <div class="item"> <span class="glyphicon glyphicon-map-marker"></span> </div> </div> </div> </header> <div class="headered footered" style="width: 100%;"> <tabbarcontroller tabs="{[         { tagName : ⁗mapviewcontroller⁗, opts : {} },         { tagName : ⁗aboutviewcontroller⁗, opts : {} }     ]}"></tabbarcontroller> </div> <footer> <div class="tab-bar"> <div class="items"> <a href="#/map" class="active"> <span class="glyphicon glyphicon-map-marker"></span> <label>Map</label> </a> <a href="#/settings"> <span class="glyphicon glyphicon-cog"></span> <label>About</label> </a> </div> </div> </footer>', '', '', function(opts) {
});
...
riot$1.tag2('application', '<rootviewcontroller></rootviewcontroller>', '', '', function(opts) {
hooks.locale('jp');
});
